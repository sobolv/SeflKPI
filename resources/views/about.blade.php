...
<div class="enter_words_a">
    <div class="title_a">
        Хто ми?
    </div>
    <hr class="line_title_a">
    <div class="enter_text_a">
        Переважно членами нашого конструкторського бюро є
        студенти. Це молоді уми, охочі до успіху та здатні
        на креативні і нестандартні рішення. Наша команда
        складається з різносторонніх та талановитих людей,
        які захоплюються своєю роботою і прагнуть виконати
        будь-яку поставлену задачу бездоганно.
    </div>
</div>
<div class="why">
    <div class="title_a">
